  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--charcoal)] text-[var(--cream)] px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/" className="btn-stamp">Back to the pit wall</Link>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vintage racing magazine meets modern F1 prediction. Dhir's Pit Wall covers the 2026 Formula One season." },
